...
$url = elgg_http_remove_url_query_element($url, 'username');
$url = elgg_http_remove_url_query_element($url, 'password');
$url = elgg_http_remove_url_query_element($url, 'rssguid');
$url = elgg_http_remove_url_query_element($url, 'rsstoken');
